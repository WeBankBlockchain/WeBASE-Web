  ...
  <div>
    ...
    >
        ...
        >
          ...
          <el-form-item :label="$t('alarm.alarmContent')" prop="alertContent">
            ...
            <el-tooltip
              class="item"
              effect="dark"
              :content="$t('alarm.alarmContentTip')"
              placement="top-start"
            >
          ...
          <el-form-item :label="$t('alarm.recipientEmail')">
            <el-select
              v-model="alarmForm.userList"
              multiple
              :placeholder="$t('alarm.pleaseSlect')"
            ...
            <el-tooltip
              class="item"
              effect="dark"
              :content="$t('alarm.recipientEmailTip')"
              placement="top-start"
            >
              <i class="el-icon-info"></i>
            </el-tooltip>
          ...
          >
            <el-select
              v-model="alarmForm.alertIntervalSeconds"
              :placeholder="$t('alarm.pleaseSlect')"
              style="width: 250px"
            >
              <el-option
                :label="item.lable"
                :value="item.value"
                v-for="item in alertIntervalSecondsList"
                :key="item.value"
              ></el-option>
            </el-select>
            <el-tooltip
              class="item"
              effect="dark"
              :content="$t('alarm.alertIntervalSecondsTip')"
              placement="top-start"
            >
              <i class="el-icon-info"></i>
            </el-tooltip>
      ...
      <div class="text-right sure-btn" style="margin-top: 10px">
        ...
        <el-button type="primary" @click="submitForm('alarmForm')">{{
          $t("alarm.sure")
        }}</el-button>
      </div>
    </el-dialog>
