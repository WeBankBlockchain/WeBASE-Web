            ...
            <template slot-scope="scope">
              ...
              <template v-else-if="head.enName === 'operate'">
                <el-button
                  ...
                  v-hasPermi="['bcos3:chain:startNode']"
                ...
                <el-button
                  ...
                  v-hasPermi="['bcos3:chain:stopNode']"
                ...
                <el-button
                  ...
                  v-hasPermi="['bcos3:chain:updateNodeDesc']"
                ...
                <el-button
                  ...
                  v-hasPermi="['bcos3:chain:restartNode']"
    ...
    checkAuth() {
      getPermissionManagementStatus(localStorage.getItem("groupId"))
        .then((res) => {
          ...
          console.log(
            "!!!getPermissionManagementStatus,this.isAuthEnable:",
            this.isAuthEnable
          );
        })
        .catch((err) => {});
