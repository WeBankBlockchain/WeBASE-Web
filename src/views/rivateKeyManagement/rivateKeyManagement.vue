...
<template>
    <div class="rivate-key-management-wrapper">
                        ...
                        <template slot-scope="scope">
                            <template v-if="head.enName!='operate'">
                                ...
                                <span v-else-if="head.enName ==='address'">
                                    <i class="wbs-icon-copy font-12 copy-public-key" @click="copyPubilcKey(scope.row[head.enName])" :title="$t('privateKey.copyPublicKey')"></i>
        ...
        <el-dialog :visible.sync="$store.state.creatUserVisible" :title="$t('privateKey.createUser')" width="630px" :append-to-body="true" class="dialog-wrapper" v-if='$store.state.creatUserVisible' center>
