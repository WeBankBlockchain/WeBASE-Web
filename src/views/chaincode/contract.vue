        ...
        this.allVersion = [
            {
                solcName: "v0.4.25",
                versionId: 0,
                url: `${this.protocol}//${this.host}/static/js/v0.4.25.js`,
                encryptType: 0,
                net: 1
            },
            {
                solcName: "v0.4.25-gm",
                versionId: 1,
                url: `${this.protocol}//${this.host}/static/js/v0.4.25-gm.js`,
                encryptType: 1,
                net: 1
            },
            {
                solcName: "v0.5.2",
                url: `${this.protocol}//${this.host}/static/js/v0.5.2.js`,
                versionId: 2,
                encryptType: 0,
                net: 1
            },
            {
                solcName: "v0.5.2-gm",
                versionId: 3,
                url: `${this.protocol}//${this.host}/static/js/v0.5.2-gm.js`,
                encryptType: 1,
                net: 1
            },
            {
                solcName: "v0.6.10",
                versionId: 4,
                url: `${this.protocol}//${this.host}/static/js/v0.6.10.js`,///\/static\/js\/
                encryptType: 0,
                net: 1
            },
            {
                solcName: "v0.6.10-gm",
                versionId: 5,
                url: `${this.protocol}//${this.host}/static/js/v0.6.10-gm.js`,
                encryptType: 1,
                net: 1
            }
        ];
