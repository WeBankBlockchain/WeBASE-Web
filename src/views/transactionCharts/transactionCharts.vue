            ...
            <div class="more-search-table search-min-width">
                <div class="text-left">
                    <div class="text-left-label">
                        ...
                        <el-select v-model="userName" @change="changeUserName" class="select-32" clearable  :placeholder="$t('text.select')">
                    ...
                    <div class="text-left-label1">
                        ...
                        <el-select v-model="interfaceName" @change="changeInterfaceName" class="select-32" clearable  :placeholder="$t('text.select')">
