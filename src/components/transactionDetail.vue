      ...
      <el-tab-pane :label="$t('table.transactionInfo')">
        <div>
          ...
          <div class="item">
            ...
            <el-tooltip v-else-if="transactionData.to!=''" class="tip" effect="dark" :content="$t('contracts.toTip1')" placement="top-start">
              <i class="el-icon-info"></i>
            </el-tooltip>
          </div>
          <div class="item">
        ...
        <el-row v-for="item in txReceiptInfoList" :key="item">
          ...
          <el-col :xs='24' :sm="24" :md="18" :lg="20" :xl="22">
            ...
            <template v-else-if="item == 'to'">
              ...
              <el-tooltip v-if="txInfoReceiptMap[item]=='0x0000000000000000000000000000000000000000'" class="tip" effect="dark" :content="$t('contracts.toTip')" placement="top-start">
                <i class="el-icon-info"></i>
              </el-tooltip>
...
export default {
  ...
  mounted: function () {
    this.liquidCheck = this.$store.state.liquidCheck;
  ...
  methods: {
    ...
    txStatusMessage(val) {
      switch (val) {
        ...
        case 17:
          return this.$t("editor.ContractAddressAlreadyUsed");
        case 18:
        ...
        case 23:
          return this.$t("editor.AccountAbolished");
        case 24:
          return this.$t("editor.ContractAbolished");
        case 32:
