export default {
    ...
    editor:{
        ...
        BadInstruction:'错误指令异常', 
        BadJumpDestination:'错误目的跳转异常', 
        OutOfGas:'合约执行时gas不足 / 部署的合约长度超过最长上限', 
        OutOfStack:'栈溢出异常', 
        StackUnderflow:'栈下限溢位异常', 
        ...
        CallAddressError:'被调用的合约地址不存在', 
        GasOverflow:'Gas溢出错误', 
        TxPoolIsFull:'交易池已满异常', 
        TransactionRefused:'交易被拒绝异常', 
        ContractFrozen:'合约被冻结异常', 
        AccountFrozen:'账户被冻结异常', 
