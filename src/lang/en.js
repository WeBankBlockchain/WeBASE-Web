export default {
    ...
    text: {
        ...
        reset: "Delete chain",
        resetSuccess: "Successfully initiated the reset contract administrator proposal",
        deploying: "Deploying",
    ...
    contracts: {
        ...
        toTip1: "To of the transaction receipt of deploying the contract is empty or all 0",
         contractAddressTip: "The contractAddress field in the transaction that deploys the contract is the contract address",
         contractAddressTip1: "ContractAddress of the transaction receipt of calling the contract is empty or all 0",
    ...
    editor:{
        ...
        BadInstruction: 'Bad instruction exception',
        BadJumpDestination: 'Wrong destination jump exception',
        OutOfGas: 'The gas is insufficient when the contract is executed / the length of the deployed contract exceeds the maximum limit',
        OutOfStack: 'Stack overflow exception',
        StackUnderflow: 'Stack lower limit overflow exception',
        NonceCheckFail: 'Nonce check failed exception',
        BlockLimitCheckFail: 'blocklimit check failed exception',
        FilterCheckFail: 'filter detection failure exception',
        ...
        RevertInstruction: 'The revert command is abnormal, please check the called contract content',
        ...
        CallAddressError: 'The called contract address does not exist',
        GasOverflow: 'Gas overflow error',
        TxPoolIsFull: 'The transaction pool is full abnormally',
        TransactionRefused: 'Transaction rejected exception',
        ContractFrozen: 'The contract is frozen abnormally',
        AccountFrozen: 'The account is frozen abnormally',
        AlreadyKnown: 'The transaction is already in the transaction pool',
        AlreadyInChain: 'The transaction has been on the chain abnormally',
        ...
        WASMValidationFailure: 'ECDSA or SM2 encrypt type of transaction does not match the chain is used',
         WASMArgumentOutOfRange: 'Too many parameters were passed in when deploying the Liquid contract',
         WASMUnreachableInstruction: 'Illegal opcode is used in Liquid or the version of Liquid compiler is too low',
    },
    privateKey: {
        addUser: "Add Users",
    ...
    govCommittee: {
        ...
        setAdmin: "Set the user's call permission to a contract method",
         ...
         resetTips: 'The reset contract administrator will initiate a proposal, and a corresponding vote is required. ',
    },
    devOpsMgmt: {
