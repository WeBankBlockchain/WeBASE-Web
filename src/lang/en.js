export default {
    ...
    text: {
        ...
        automatic: "Automatic",
        imageModeInfo1: "Automatic: pull the image from CDN to the host.",
        imageModeInfo2: "Manual: Manually upload docker image compression package to the host.",
        imageModeInfo3: "dockerhub：pull the image from the docker website to the host.",
        ...
        chainConfigSuccess: "Chain configuration successful",
        addNodeConfigSuccess: "New node configured successfully",
        new: "New",
        configSuccess: "Host chain configured successfully",
        configFail: "Host chain configured failed",
        NotCheck: "Not check",
        addHost: "New host",
        ...
        portConflict: "There is a port conflict.",
        used: "Has been used",
